...
public class CoursesController extends BaseController
{
     ...
     * 查询课程管理列表
     */
    @PreAuthorize("@ss.hasPermi('courses:course:list')")
    @GetMapping("/list")
     ...
     * 导出课程管理列表
     */
    @PreAuthorize("@ss.hasPermi('courses:course:export')")
     ...
     * 获取课程管理详细信息
     */
    @PreAuthorize("@ss.hasPermi('courses:course:query')")
     ...
     * 新增课程管理
     */
    @PreAuthorize("@ss.hasPermi('courses:course:add')")
     ...
     * 修改课程管理
     */
    @PreAuthorize("@ss.hasPermi('courses:course:edit')")
     ...
     * 删除课程管理
     */
    @PreAuthorize("@ss.hasPermi('courses:course:remove')")

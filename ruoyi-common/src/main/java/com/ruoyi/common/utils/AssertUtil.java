...
public class AssertUtil {
    ...
    public static <T> void equal(T val, T except, String msg) {
        AssertUtil.isTrue(Objects.equals(val, except), msg);
    }
    public static <T> void notEqual(T val, T except, String msg) {
        AssertUtil.isTrue(!Objects.equals(val, except), msg);
    }

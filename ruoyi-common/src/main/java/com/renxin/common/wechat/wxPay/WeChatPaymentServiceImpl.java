...
public class WeChatPaymentServiceImpl implements WechatPaymentService {
     ...
     */
    @Override
    public Map<String, Object>weChatDoUnifiedOrder(String orderNo, BigDecimal payAmount, String title) {
        Map<String,Object> map =new HashMap<>();
        //支付总金额
        BigDecimal totalPrice = BigDecimal.ZERO;
        totalPrice = totalPrice.add(BigDecimal.valueOf(600));
        //转换金额保留两位小数点
        Integer payAmountInt = payAmount.movePointRight(2).intValue();
        try {
            //验证证书

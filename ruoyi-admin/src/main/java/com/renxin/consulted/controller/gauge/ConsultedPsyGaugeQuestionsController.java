 ...
 */
@RestController
@RequestMapping("/consulted/gauge/questions")
@Api(value = "consultedPsyGaugeQuestionsController" ,tags = {"测评问题api"})
public class ConsultedPsyGaugeQuestionsController extends BaseController
{
    @Autowired

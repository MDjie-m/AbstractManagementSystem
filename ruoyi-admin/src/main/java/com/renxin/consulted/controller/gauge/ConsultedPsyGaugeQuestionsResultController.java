 ...
 */
@RestController
@RequestMapping("/consulted/gauge/result")
@Api(value = "consultedPsyGaugeQuestionsResultController" ,tags = {"测评结果提交"})
public class ConsultedPsyGaugeQuestionsResultController extends BaseController
{

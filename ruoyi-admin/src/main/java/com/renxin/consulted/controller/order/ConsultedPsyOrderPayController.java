 ...
 */
@RestController
@RequestMapping("/consulted/gauge/order/pay")
@Api(value = "consultedPsyOrderPayController" ,tags = {"心理测评支付信息api"})
public class ConsultedPsyOrderPayController extends BaseController {
    @Autowired

package com.renxin.consulted.controller.marketing;
...
@RestController
@RequestMapping("/consulted/user/integral")
public class ConsultedPsyUserIntegralController extends BaseController {

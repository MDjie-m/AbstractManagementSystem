 ...
 **/
@RestController
@RequestMapping("/consulted/home/gauge/label")
@Api(value = "consultedPsyGaugeLabelController" ,tags = {"测评标签api"})
public class ConsultedPsyGaugeLabelController extends BaseController {

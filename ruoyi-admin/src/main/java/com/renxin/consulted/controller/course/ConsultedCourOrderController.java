...
@RestController
@RequestMapping("/consulted/course/order")
@Api(value = "consultedCourOrderController" ,tags = {"课程订单API"})
public class ConsultedCourOrderController extends BaseController
{
    @Autowired

...
@RestController
@RequestMapping("/consulted/course/class")
@Api(value = "consultedCourCourseClassController" ,tags = {"课程类型API"})
public class ConsultedCourCourseClassController extends BaseController
{
    @Autowired

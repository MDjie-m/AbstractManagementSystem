 ...
 */
@RestController
@RequestMapping("/consulted/course/label")
@Api(value = "consultedCourCourseLabelController" ,tags = {"课程标签API"})
public class ConsultedCourCourseLabelController extends BaseController
{
    @Autowired

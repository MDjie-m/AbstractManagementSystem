 ...
 */
@RestController
@RequestMapping("/consulted/home/banner/config")
@Api(value = "consultedPsyGaugeBannerConfigController" ,tags = {"测评banner页配置控制器"})
public class ConsultedPsyGaugeBannerConfigController extends BaseController
{
    @Resource

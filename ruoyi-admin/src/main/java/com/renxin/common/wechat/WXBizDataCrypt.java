package com.renxin.common.wechat;
...
public class WXBizDataCrypt {
    ...
    private final String WEAPP_WATERMARK = "watermark";

    private final String WEAPP_APPID = "appid";
    ...
    public JSONObject decrypt(String encryptedData, String iv) throws Exception {
        ...
        if (!jsonObject.getJSONObject(WEAPP_WATERMARK).get(WEAPP_APPID).toString().equals(this.appId)){
            throw new Exception("Illegal Buffer");
        }
        return jsonObject;
    }

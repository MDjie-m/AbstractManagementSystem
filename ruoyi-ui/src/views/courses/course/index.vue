<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="科目/分类" prop="subject">
        <el-select v-model="queryParams.subject" placeholder="请选择科目/分类" clearable>
          <el-option
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['courses:course:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['courses:course:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['courses:course:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="courseList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="科目/分类" align="center" prop="subject">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.course_type" :value="scope.row.subject"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="科目/分类" prop="subject">
          <el-select v-model="form.subject" placeholder="请选择科目/分类">
            <el-option
              v-for="dict in dict.type.course_type"
              :key="dict.value"
              :label="dict.label"
...
<script>
import { listCourse, getCourse, delCourse, addCourse, updateCourse } from "@/api/courses/course";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('courses/course/export', {
        ...this.queryParams

<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="menuCategory" label="所属系统" width="80"  >
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_menu_category" :value="scope.row.menuCategory"/>
        </template>
      </el-table-column>
...
export default {
  name: 'Menu',
  dicts: ['sys_show_hide', 'sys_normal_disable', 'sys_menu_category'],
  ...
  methods: {
    ...
    getList() {
      ...
      listMenu(this.queryParams).then(response => {
        let list =  this.handleTree(response.data, 'menuId');
        // let lastList=[];
        // this.dict.type.sys_menu_category.forEach(p=>{
        //    lastList.push({id:p.value,name:p.label,childrenList:list.filter(p=>p.menuCategory===p.value)});
        // })
        this.menuList =list;

  ...
  <el-dialog title="新建套餐" :visible.sync="open" width="1000px" append-to-body>
    <el-form ref="form" :model="form" :rules="rules" label-width="80px">
      ...
      <el-form-item label="套餐名称" prop="productName">
        <el-input v-model="form.productName" placeholder="请输入套餐名称" disabled />
      </el-form-item>
      ...
      <el-form-item label="个人体验券张数" prop="personExpNum" >
        <el-input-number v-model="form.personExpNum" :min="0" :step="1" :precision="0" disabled/> 次
      </el-form-item>

      <el-form-item label="课程券张数" prop="courseNum" >
        <el-input-number v-model="form.courseNum" :min="0" :step="1" :precision="0" disabled/> 次
      </el-form-item>

<template>
  <div class="addShoolMain">
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px">
      <el-form-item label="校区名称" prop="name">
        <el-input v-model="ruleForm.name" placeholder="请输入校区名称" clearable style="width:280px"></el-input>
      </el-form-item>
      ...
      <el-form-item label="学段" prop="sort">
        <el-checkbox-group v-model="checkList">
          <el-checkbox label="幼儿园">
            <div class="flex">
              <div class="mr-10">幼儿园</div>
              <el-select placeholder="请选择">
                <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value">
                </el-option>
              </el-select>
              <span class="ml">个年级</span>
            </div>
          </el-checkbox>
          <el-checkbox label="小学">
            <div class="flex">
              <div class="mr-10">小学</div>
              <el-select placeholder="请选择">
                <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value">
                </el-option>
              </el-select>

<template>
  <el-dialog title="新建年级" :visible.sync="dialogVisible" width="30%" :show-close="false" :before-close="handleClose">
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="80px">
      ...
      <el-form-item label="班级数" prop="name">
        <el-input v-model="ruleForm.name" placeholder="请输入班级数" clearable style="width:280px" />
      </el-form-item>

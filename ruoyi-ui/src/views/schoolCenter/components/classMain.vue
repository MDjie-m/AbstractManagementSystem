    ...
    <el-tabs v-model="activeName">
      <el-tab-pane label="基本信息" name="0">
        <el-tabs v-model="sendValue" class="sendValue">
          <el-tab-pane label="年级（2个班级,0人）" name="0">
            <template v-if="step===''">
              <el-row :gutter="10" class="mb8">
                <el-col :span="1.5">
                  <el-button type="primary" size="mini" @click="addSchoolArea">添加班级</el-button>
                  <el-button type="primary" size="mini" @click="invite">邀请家长</el-button>
                </el-col>
              </el-row>

              <el-table v-loading="loading" :data="shoolList">
                <el-table-column label="班级" prop="noticeTitle" />
                <el-table-column label="学生总数" prop="noticeType"></el-table-column>
                <el-table-column label="家长总数" prop="sender" />
                <el-table-column label="班主任" prop="sender" />
                <el-table-column label="任课教师" prop="sendTime" />
...
export default {
  ...
  methods: {
    ...
    // 添加学段
    addSchoolArea() {
      this.$refs.addGradeRef.dialogVisible = true
    },
    next() {
      this.step = '2'
    },

      ...
      <div class="container-div">
        <div class=" col-sm-12 search-collapse" v-show="showSearch">
          <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" label-width="68px">
            ...
            <el-form-item label="计费状态" prop="status">
              <el-select v-model="queryParams.status" placeholder="请选择状态" clearable>
                <el-option
                  v-for="dict in dict.type.store_desk_status"
                  :key="dict.value"
                  :label="dict.label"
                  :value="dict.value"
                />
            ...
            <el-form-item>
              <el-button type="primary" class="btn btn-primary btn-rounded btn-sm" icon="el-icon-search" size="mini"
                         @click="handleQuery"
              >搜索
              </el-button>
              <el-button icon="el-icon-refresh" class="btn btn-primary btn-rounded btn-sm" size="mini"
                         @click="resetQuery"
              >重置
              </el-button>
            </el-form-item>
        ...
        <div class="col-sm-12 select-table table-striped">
          ...
          <el-table v-loading="loading" :data="deskList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="计费状态" align="center" prop="status">
              <template slot-scope="scope">
                <dict-tag :options="dict.type.store_desk_status" :value="scope.row.status"/>
              </template>
            </el-table-column>

<template>
  <div class="container-div">
    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="门店状态" prop="status">
        <el-select v-model="queryParams.status" placeholder="请选择门店状态" clearable>
          <el-option
            v-for="dict in dict.type.store_state"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-table v-loading="loading" :data="storeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="门店图片" align="center" prop="storeImg" width="100">
        <template slot-scope="scope">
          <image-preview :src="scope.row.storeImg" :width="50" :height="50"/>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['billiard:store:edit']"
          >修改</el-button>
          <el-button
            size="mini"
            type="text"
            ...
            v-hasPermi="['billiard:store:remove']"
          >删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="门店名称" prop="storeName">
          <el-input v-model="form.storeName" placeholder="请输入门店名称" maxlength="60"/>
        </el-form-item>
        <el-form-item label="门店地址" prop="storeAddress">
          <el-input v-model="form.storeAddress" placeholder="请输入门店地址" maxlength="200"/>
        </el-form-item>
        <el-form-item label="门店图片" prop="storeImg">
          <image-upload v-model="form.storeImg" :limit="1" />
        </el-form-item>
        <el-form-item label="门店状态" prop="status">
        ...
        <el-form-item label="备注" prop="remark" >
          <el-input v-model="form.remark" type="textarea" placeholder="请输入内容" maxlength="400"/>
        </el-form-item>
      </el-form>
...
<script>
import {listStore, getStore, delStore, addStore, updateStore} from "@/api/billiard/store";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('billiard/store/export', {
        ...this.queryParams

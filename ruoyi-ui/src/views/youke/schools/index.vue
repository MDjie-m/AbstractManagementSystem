<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['workflow:schools:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['workflow:schools:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['workflow:schools:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['workflow:schools:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="schoolsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="学校ID" align="center" prop="id" v-if="true"/>
  ...
  methods: {
    ...
    getList() {
      ...
      listSchools(this.queryParams).then(response => {
        this.schoolsList = response.rows;
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          ...
          if (this.form.id != null) {
            updateSchools(this.form).then(response => {
            ...
            addSchools(this.form).then(response => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('workflow/schools/export', {
        ...this.queryParams

...
<script>
import { listTest, getTest, delTest, addTest, updateTest } from "@/api/module/test";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('module/test/export', {
        ...this.queryParams

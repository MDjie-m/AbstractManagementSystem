  ...
  <el-row :gutter="40" class="panel-group">
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('newVisitis')">
        <div class = "card-text">
          <a target="_blank" href="https://gitee.com/nbacheng/ruoyi-nbcio"><span class="profile-name">前后端代码</span></a><br/>
            <a target="_blank" href="http://218.75.87.38:9666"><span class="profile-name">在线演示</span></a><br/>
            <a target="_blank" href="https://nbacheng.blog.csdn.net/"><span class="profile-name">博客地址</span></a>&nbsp;&nbsp;&nbsp;&nbsp;<a target="_blank" href="https://www.kancloud.cn/nbacheng/nbcio_estar/3201127"><span class="profile-name">临时在线帮助</span></a><br/>

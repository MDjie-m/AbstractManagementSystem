...
public class PsyConstants {
    ...
    public static final String CONSULTANT_ORDER_PERSON_SUP = "GRDD"; //个案督导
    ...
    public static final String CONSULTANT_ORDER_PERSON_SUP_NUM = "2"; //个案督导
    ...
    public static final String SERVICE_OBJECT_PERSON_SUP = "2"; //个案督导

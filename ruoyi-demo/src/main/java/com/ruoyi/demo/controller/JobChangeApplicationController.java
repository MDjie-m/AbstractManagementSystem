 ...
 */
@RestController
@RequestMapping("/demo/application")
public class JobChangeApplicationController extends BaseController
{
     ...
     * 查询调岗申请列表
     */
    @PreAuthorize("@ss.hasPermi('demo:application:list')")
    @GetMapping("/list")
     ...
     * 导出调岗申请列表
     */
    @PreAuthorize("@ss.hasPermi('demo:application:export')")
     ...
     * 获取调岗申请详细信息
     */
    @PreAuthorize("@ss.hasPermi('demo:application:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增调岗申请
     */
    @PreAuthorize("@ss.hasPermi('demo:application:add')")
     ...
     * 修改调岗申请
     */
    @PreAuthorize("@ss.hasPermi('demo:application:edit')")
     ...
     * 删除调岗申请
     */
    @PreAuthorize("@ss.hasPermi('demo:application:remove')")
